...
cm_lownmg_esc_bed:
    %preset("Link's Bed", preset_lownmg_esc_bed)

cm_lownmg_esc_courtyard:
    %preset("Courtyard", preset_lownmg_esc_courtyard)

cm_lownmg_esc_entrance:
    %preset("Entrance", preset_lownmg_esc_entrance)

cm_lownmg_esc_1st_keyguard:
    %preset("1st Key Guard", preset_lownmg_esc_1st_keyguard)

cm_lownmg_esc_stealth_room:
    %preset("Stealth Room", preset_lownmg_esc_stealth_room)

cm_lownmg_esc_2nd_keyguard:
    %preset("2nd Key Guard", preset_lownmg_esc_2nd_keyguard)

cm_lownmg_esc_ball_n_chains:
    %preset("Ball'n Chains", preset_lownmg_esc_ball_n_chains)

cm_lownmg_esc_backtracking:
    %preset("Backtracking", preset_lownmg_esc_backtracking)

cm_lownmg_esc_keyguard_revisited:
    %preset("Key Guard Revisited", preset_lownmg_esc_keyguard_revisited)

cm_lownmg_esc_throne_room:
    %preset("Throne Room", preset_lownmg_esc_throne_room)

cm_lownmg_esc_snake_avoidance_room:
    %preset("Snake Avoidance Room", preset_lownmg_esc_snake_avoidance_room)

cm_lownmg_esc_water_rooms:
    %preset("Sewer Rooms", preset_lownmg_esc_water_rooms)

cm_lownmg_esc_keyrat:
    %preset("Key Rat", preset_lownmg_esc_keyrat)

cm_lownmg_esc_last_two_screens:
    %preset("Last Two Screens", preset_lownmg_esc_last_two_screens)
...
cm_lownmg_east_before_cutscene:
    %preset("Before Cutscene", preset_lownmg_east_before_cutscene)

cm_lownmg_east_after_cutscene:
    %preset("After Cutscene", preset_lownmg_east_after_cutscene)

cm_lownmg_east_octoroc:
    %preset("Octoroc OW", preset_lownmg_east_octoroc)

cm_lownmg_east_outside_palace:
    %preset("EP Overworld", preset_lownmg_east_outside_palace)

cm_lownmg_east_entrance:
    %preset("Entrance", preset_lownmg_east_entrance)

cm_lownmg_east_stalfos_room:
    %preset("Stalfos Room", preset_lownmg_east_stalfos_room)

cm_lownmg_east_big_chest_room_1:
    %preset("Big Chest Room 1", preset_lownmg_east_big_chest_room_1)

cm_lownmg_east_dark_key_room:
    %preset("Dark Key Room", preset_lownmg_east_dark_key_room)

cm_lownmg_east_big_key_dmg_boost:
    %preset("Big Key DMG Boost", preset_lownmg_east_big_key_dmg_boost)

cm_lownmg_east_big_chest_room_2:
    %preset("Big Chest Room 2", preset_lownmg_east_big_chest_room_2)

cm_lownmg_east_gwg:
    %preset("Gifted With Greenies", preset_lownmg_east_gwg)

cm_lownmg_east_pot_room:
    %preset("Pot Room", preset_lownmg_east_pot_room)

cm_lownmg_east_zeldagamer_room:
    %preset("Zeldagamer Room", preset_lownmg_east_zeldagamer_room)

cm_lownmg_east_armos:
    %preset("Armos", preset_lownmg_east_armos)
...
cm_lownmg_presets_goto_atower:
    %submenu("Agahnim's Tower", cm_lownmg_presets_atower)
...
cm_lownmg_sw_outside_thieves:
    %preset("Outside Thieves", preset_lownmg_sw_outside_thieves)

cm_lownmg_sw_dash_to_sw:
    %preset("Dash to Skull Woods", preset_lownmg_sw_dash_to_sw)

cm_lownmg_sw_mummy_room:
    %preset("Mummy Room", preset_lownmg_sw_mummy_room)

cm_lownmg_sw_bomb_jump:
    %preset("Bomb Jump", preset_lownmg_sw_bomb_jump)

cm_lownmg_sw_key_pot:
    %preset("Key Pot", preset_lownmg_sw_key_pot)

cm_lownmg_sw_skull_entrance:
    %preset("Skull Entrance", preset_lownmg_sw_skull_entrance)

cm_lownmg_sw_mummy_hellway:
    %preset("Mummy Hellway", preset_lownmg_sw_mummy_hellway)

cm_lownmg_sw_mummy_key:
    %preset("Mummy Key", preset_lownmg_sw_mummy_key)

cm_lownmg_sw_mothula:
    %preset("Mothula", preset_lownmg_sw_mothula)
