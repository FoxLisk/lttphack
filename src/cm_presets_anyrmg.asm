...
cm_anyrmg_east_bed:
    %preset("Link's Bed", preset_anyrmg_east_bed)

cm_anyrmg_east_courtyard_1:
    %preset("Courtyard 1", preset_anyrmg_east_courtyard_1)

cm_anyrmg_east_castle_entrance:
    %preset("Castle Entrance", preset_anyrmg_east_castle_entrance)

cm_anyrmg_east_courtyard_2:
    %preset("Courtyard 2", preset_anyrmg_east_courtyard_2)

cm_anyrmg_east_links_house_citrus:
    %preset("Link's House Citrus", preset_anyrmg_east_links_house_citrus)

cm_anyrmg_east_outside_palace:
    %preset("Eastern Overworld", preset_anyrmg_east_outside_palace)

cm_anyrmg_east_entrance:
    %preset("Entrance", preset_anyrmg_east_entrance)

cm_anyrmg_east_stalfos_room:
    %preset("Stalfos Room", preset_anyrmg_east_stalfos_room)

cm_anyrmg_east_big_chest_room_1:
    %preset("Big Chest Room 1", preset_anyrmg_east_big_chest_room_1)

cm_anyrmg_east_dark_antifairies_room:
    %preset("Dark Antifairies Room", preset_anyrmg_east_dark_antifairies_room)

cm_anyrmg_east_dark_key_room:
    %preset("Dark Key Room", preset_anyrmg_east_dark_key_room)

cm_anyrmg_east_big_key_dmg_boost:
    %preset("Big Key DMG Boost", preset_anyrmg_east_big_key_dmg_boost)

cm_anyrmg_east_big_chest_room_2:
    %preset("Big Chest Room 2", preset_anyrmg_east_big_chest_room_2)

cm_anyrmg_east_gwg:
    %preset("Gifted With Greenies", preset_anyrmg_east_gwg)

cm_anyrmg_east_pot_room:
    %preset("Pot Room", preset_anyrmg_east_pot_room)

cm_anyrmg_east_zeldagamer_room:
    %preset("Zeldagamer Room", preset_anyrmg_east_zeldagamer_room)

cm_anyrmg_east_armos:
    %preset("Armos", preset_anyrmg_east_armos)
...
cm_anyrmg_esc_outside_eastern:
    %preset("Outside Eastern", preset_anyrmg_esc_outside_eastern)

cm_anyrmg_esc_eastern_spinspeed:
    %preset("Eastern Spinspeed", preset_anyrmg_esc_eastern_spinspeed)

cm_anyrmg_esc_dma:
    %preset("DMA", preset_anyrmg_esc_dma)

cm_anyrmg_esc_death_mountain:
    %preset("Death Mountain", preset_anyrmg_esc_death_mountain)

cm_anyrmg_esc_kiki_yeet:
    %preset("Kiki Yeet", preset_anyrmg_esc_kiki_yeet)

cm_anyrmg_esc_kiki_skip:
    %preset("Kiki Skip", preset_anyrmg_esc_kiki_skip)

cm_anyrmg_esc_pod_main_hub_bk:
    %preset("PoD Main Hub (Big Key)", preset_anyrmg_esc_pod_main_hub_bk)

cm_anyrmg_esc_pod_main_hub_hammerjump:
    %preset("PoD Main Hub (Hammerjump)", preset_anyrmg_esc_pod_main_hub_hammerjump)

cm_anyrmg_esc_hammerjump:
    %preset("Hammerjump", preset_anyrmg_esc_hammerjump)

cm_anyrmg_esc_sanc_1:
    %preset("River Clip", preset_anyrmg_esc_sanc_1)

cm_anyrmg_esc_entrance:
    %preset("Entrance", preset_anyrmg_esc_entrance)

cm_anyrmg_esc_1st_keyguard:
    %preset("1st Key Guard", preset_anyrmg_esc_1st_keyguard)

cm_anyrmg_esc_stealth_room:
    %preset("Not So Stealth Room", preset_anyrmg_esc_stealth_room)

cm_anyrmg_esc_2nd_keyguard:
    %preset("2nd Key Guard", preset_anyrmg_esc_2nd_keyguard)

cm_anyrmg_esc_zeldas_cell:
    %preset("Zelda's Cell", preset_anyrmg_esc_zeldas_cell)

cm_anyrmg_esc_sanc_2:
    %preset("Sanctuary", preset_anyrmg_esc_sanc_2)
...
cm_anyrmg_temp_old_man_cave:
    %preset("Old Man Cave", preset_anyrmg_temp_old_man_cave)

cm_anyrmg_temp_hera_entrance:
    %preset("Hera Entrance", preset_anyrmg_temp_hera_entrance)

cm_anyrmg_temp_hera_beetles:
    %preset("Beetles", preset_anyrmg_temp_hera_beetles)

cm_anyrmg_temp_hera_petting_zoo:
    %preset("Petting Zoo", preset_anyrmg_temp_hera_petting_zoo)

cm_anyrmg_temp_frog_dmd:
    %preset("Frog DMD", preset_anyrmg_temp_frog_dmd)

cm_anyrmg_temp_getting_tempered:
    %preset("Getting Tempered", preset_anyrmg_temp_getting_tempered)
