...
cm_hundo_esc_bed:
	%preset("Link's Bed", preset_hundo_esc_bed)

cm_hundo_esc_courtyard:
	%preset("Courtyard", preset_hundo_esc_courtyard)

cm_hundo_esc_entrance:
	%preset("Entrance", preset_hundo_esc_entrance)

cm_hundo_esc_1st_keyguard:
	%preset("1st Key Guard", preset_hundo_esc_1st_keyguard)

cm_hundo_esc_stealth_room:
	%preset("Stealth Room", preset_hundo_esc_stealth_room)

cm_hundo_esc_2nd_keyguard:
	%preset("2nd Key Guard", preset_hundo_esc_2nd_keyguard)

cm_hundo_esc_ball_n_chains:
	%preset("Ball'n Chains", preset_hundo_esc_ball_n_chains)

cm_hundo_esc_backtracking:
	%preset("Backtracking", preset_hundo_esc_backtracking)

cm_hundo_esc_keyguard_revisited:
	%preset("Key Guard Revisited", preset_hundo_esc_keyguard_revisited)

cm_hundo_esc_throne_room:
	%preset("Throne Room", preset_hundo_esc_throne_room)

cm_hundo_esc_snake_avoidance_room:
	%preset("Snake Avoidance Room", preset_hundo_esc_snake_avoidance_room)

cm_hundo_esc_water_rooms:
	%preset("Sewer Rooms", preset_hundo_esc_water_rooms)

cm_hundo_esc_keyrat:
	%preset("Key Rat", preset_hundo_esc_keyrat)

cm_hundo_esc_last_two_screens:
	%preset("Last Two Screens", preset_hundo_esc_last_two_screens)
...
cm_hundo_east_before_cutscene:
	%preset("Before Cutscene", preset_hundo_east_before_cutscene)

cm_hundo_east_after_cutscene:
	%preset("After Cutscene", preset_hundo_east_after_cutscene)

cm_hundo_east_octoroc:
	%preset("Octoroc OW", preset_hundo_east_octoroc)

cm_hundo_east_outside_palace:
	%preset("EP Overworld", preset_hundo_east_outside_palace)

cm_hundo_east_entrance:
	%preset("Entrance", preset_hundo_east_entrance)

cm_hundo_east_stalfos_room:
	%preset("Stalfos Room", preset_hundo_east_stalfos_room)

cm_hundo_east_big_chest_room_1:
	%preset("Big Chest Room 1", preset_hundo_east_big_chest_room_1)

cm_hundo_east_dark_key_room:
	%preset("Dark Key Room", preset_hundo_east_dark_key_room)

cm_hundo_east_big_key_dmg_boost:
	%preset("Big Key DMG Boost", preset_hundo_east_big_key_dmg_boost)

cm_hundo_east_big_chest_room_2:
	%preset("Big Chest Room 2", preset_hundo_east_big_chest_room_2)

cm_hundo_east_gwg:
	%preset("Gifted With Greenies", preset_hundo_east_gwg)

cm_hundo_east_pot_room:
	%preset("Pot Room", preset_hundo_east_pot_room)

cm_hundo_east_zeldagamer_room:
	%preset("Zeldagamer Room", preset_hundo_east_zeldagamer_room)

cm_hundo_east_armos:
	%preset("Armos", preset_hundo_east_armos)
...
cm_hundo_presets_goto_atower:
	%submenu("Agahnim's Tower", cm_hundo_presets_atower)
...
cm_hundo_sw_outside_thieves:
	%preset("Outside Thieves", preset_hundo_sw_outside_thieves)

cm_hundo_sw_cursed_dwarf:
	%preset("Cursed Dwarf", preset_hundo_sw_cursed_dwarf)

cm_hundo_sw_getting_tempered:
	%preset("Getting Tempered", preset_hundo_sw_getting_tempered)

cm_hundo_sw_fence_dash:
	%preset("Fencedash", preset_hundo_sw_fence_dash)

cm_hundo_sw_dash_to_sw:
	%preset("Dash to Skull Woods", preset_hundo_sw_dash_to_sw)

cm_hundo_sw_mummy_room:
	%preset("Mummy Room", preset_hundo_sw_mummy_room)

cm_hundo_sw_bomb_jump:
	%preset("Bomb Jump", preset_hundo_sw_bomb_jump)

cm_hundo_sw_key_pot:
	%preset("Key Pot", preset_hundo_sw_key_pot)

cm_hundo_sw_skull_entrance:
	%preset("Skull Entrance", preset_hundo_sw_skull_entrance)

cm_hundo_sw_mummy_hellway:
	%preset("Mummy Hellway", preset_hundo_sw_mummy_hellway)

cm_hundo_sw_mummy_key:
	%preset("Mummy Key", preset_hundo_sw_mummy_key)

cm_hundo_sw_mothula:
	%preset("Mothula", preset_hundo_sw_mothula)
