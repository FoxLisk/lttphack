...
;===============================================================================
%menu_header("100% NMG", 15)
	%submenu("Hyrule Castle", presetmenu_hundo_escape)
	%submenu("Eastern", presetmenu_hundo_eastern)
	%submenu("Desert", presetmenu_hundo_desert)
	%submenu("Hera", presetmenu_hundo_hera)
...
;-------------------------------------------------------------------------------
%preset_UW("Big Key DMG Boost", "hundo", "eastern", "big_key_dmg_boost")
dw $00B9 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Fairy Skip", "hundo", "aga", "fairy_skip")
dw $00E0 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Pit Room", "hundo", "aga", "pit_room")
dw $0040 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Main Hub (bk)", "hundo", "pod", "main_hub_bk")
dw $004A ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Main Hub (hammeryump)", "hundo", "pod", "main_hub_hammeryump")
dw $004A ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Hammeryump", "hundo", "pod", "hammeryump")
dw $002A ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Helma", "hundo", "pod", "helma")
dw $006A ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Gloves", "hundo", "thieves", "after_gloves")
dw $0044 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Backtracking", "hundo", "thieves", "backtracking_2")
dw $0044 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_OW("Medallion", "hundo", "ice", "medallion")
dw $0057 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_OW("Zoras Domain", "hundo", "ice", "zoras_domain")
dw $000F ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_OW("Outside Ice", "hundo", "mire", "outside_swamp")
dw $0075 ; Screen ID
dw $0CB8, $0DCB ; Link Coords
...
;-------------------------------------------------------------------------------
%preset_OW("Mire Overworld Screen", "hundo", "mire", "darkworld_warp")
dw $0030 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_OW("Outside Mire", "hundo", "swamp", "outside_ice")
dw $0070 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_OW("Antifairy Room", "hundo", "swamp", "antifairy_room")
dw $003B ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Hookshot", "hundo", "swamp", "hook_shot")
dw $0035 ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_OW("Outside Swamp", "hundo", "trock", "outside_mire")
dw $007B ; Screen ID
...
;-------------------------------------------------------------------------------
%preset_UW("Gauntlet 3", "hundo", "gtower", "gauntlet_3")
dw $005D ; Screen ID
...
%write8($7EF362, $80) ; Rupees (actual)
...
%write8($7EF362, $12) ; Rupees (actual)
...end
;-------------------------------------------------------------------------------
..main_hub_small_key
%write8($7EF343, $03) ; Bombs
...
;-------------------------------------------------------------------------------
..grove
%write8($7EF362, $13E) ; Rupees (actual)
...end
;-------------------------------------------------------------------------------
..usain_bolt
...
%write8($7EF362, $1A4) ; Rupees (actual)
%write8($7EF36B, $02) ; Heart pieces
%write8($7EF3CA, $00) ; LW/DW
...end
;-------------------------------------------------------------------------------
...
%write8($7EF362, $154) ; Rupees (actual)
%write8($7EF36B, $00) ; Heart pieces
...
%write8($7EF362, $136) ; Rupees (actual)
%write8($7EF343, $05) ; Bombs
%write8($7EF362, $262) ; Rupees (actual)
...
%write8($7EF3CA, $40) ; LW/DW
%write8($7EF36B, $00) ; Heart pieces
%write8($7EF36C, $78) ; Health (goal)
%write8($7EF36D, $78) ; Health (actual)
...end
;-------------------------------------------------------------------------------
..mire2
%write8($7EF36F, $00) ; Keys
...
%write8($7EF36C, $80) ; Health (goal)
%write8($7EF36D, $80) ; Health (actual)
...
%write8($7EF36E, $80) ; Magic Power
%write8($7EF36C, $88) ; Health (goal)
%write8($7EF36D, $88) ; Health (actual)
%write8($7EF37A, $77) ; Crystals
...
%write8($7EF362, $1D) ; Rupees (actual)
%write8($7EF36B, $02) ; Heart pieces
%write8($7EF36C, $90) ; Health (goal)
%write8($7EF36D, $90) ; Health (actual)
...end
;-------------------------------------------------------------------------------
..dm
...
%write8($7EF36C, $98) ; Health (goal)
%write8($7EF36D, $98) ; Health (actual)
...
%write8($7EF36B, $00) ; Heart pieces
%write8($7EF36C, $A0) ; Health (goal)
%write8($7EF36D, $A0) ; Health (actual)
...end
;-------------------------------------------------------------------------------
..spike_skip
%write8($7EF36F, $01) ; Keys
